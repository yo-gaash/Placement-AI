    ...
    <div className="relative w-full min-h-screen bg-[#050508] flex items-center justify-center overflow-hidden p-6">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold bg-gradient-to-r from-sky-400 to-violet-400 bg-clip-text text-transparent">Welcome Back</h2>
          <p className="text-gray-400 text-sm mt-1">Sign in to resume your placement journey</p>
        </div>
